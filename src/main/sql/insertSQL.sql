SET SCHEMA savorecodb.'savoreco';
...
VALUES ('GiovanniBianchi@gmail.com', 'Giovanni', 'Bianchi', encode(sha512('Giovanni123*'::bytea), 'hex'), '1985-08-15', 'Via del Mulino',
        '85100', 'IT', 'https://example.com/avatar/Giovanni.jpg'),
       ('SaraBlui@gmail.com', 'Sara', 'Blui', encode(sha512('Sara123*'::bytea), 'hex'), '1990-04-23',
        'Viale guglielmo', '85100', 'IT', 'https://example.com/avatar/Sara.jpg');

INSERT INTO restaurant (name, street, zipcode, description, image_object, delivery_cost, category, deleted)
VALUES ('McDonald', 'Viale del Besento', '85100', 'Fast Food Chain', 'https://example.com/images/McDonald.jpg',
        2.00, 'Fast Food', false),
       ('KFC', 'Via Nicola Sant angelo', '85100', 'Fast Food Chain', 'https://example.com/images/KFC.jpg',
        2.50, 'Fast Food', false),
       ('Il ritrovo dei golosi', 'Viale Italia', '85100', 'Pasticceria', 'https://example.com/images/Golosi.jpg',
...
VALUES (1, 'https://example.com/images/BigMac.jpg', 'Big Mac', 'Carne 100% bovina',
        true, 10, 'Panino', 'Glutine, Latte, Uova', 100),
       (1, 'https://example.com/images/CrispyMcBacon.jpg', 'Crispy McBacon', 'Bacon Croccante',
        true, 5, 'Panino', 'Glutine, Latte, Uova', 80),
       (2, 'https://example.com/images/BucketPollo.jpg', 'Bucket Pollo', '2 Tender Crispy, 2 Tender Original Recipe',
        true, 10, 'Pollo', 'Glutine, Latte', 75),
       (2, 'https://example.com/images/DoubleKrispy.jpg', 'Double Krispy', '2 Tender Crispy Maionese',
        true, 10, 'Panino', 'Glutine, Latte, Uova', 25),
       (3, 'https://example.com/images/Profiteroles.jpg', 'Profiteroles', 'bignè ripieni di chantilly alla gianduia',
        true, 5, 'Dolce', 'Latte, Uova', 80),
       (3, 'https://example.com/images/Crostata.jpg', 'Crostata', 'Crostata con Fragoline di Bosco',
